...
prmtop_filename = "5nad.prmtop"
inpcrd_filename = "5nad.inpcrd"
input_pdb_file = "5nad_after_leap.pdb"

# Output equilibration trajectory
trajectory_filename = "5NAD_equilibration_trajectory.pdb"
...
simulation_in_ns = num_steps * time_step.value_in_unit(unit.nanoseconds)
total_time_in_days = total_time / (86400)
ns_per_day = simulation_in_ns / total_time_in_days
print("system benchmark:", ns_per_day, "ns/day")

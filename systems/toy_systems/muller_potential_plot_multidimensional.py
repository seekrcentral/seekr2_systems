...
toy_plot = plotting.Toy_plot(model, title, boundaries, stride=4)
milestone_cv_functions = ["x=value", "value"]
plotting.draw_linear_milestones(toy_plot, milestone_cv_functions)
#ani = toy_plot.animate_trajs(animating_anchor_indices=[19])
#ani = toy_plot.animate_trajs(animating_anchor_indices=[20, 30, 18])
#ani = toy_plot.animate_trajs(animating_anchor_indices=[31, 21, 8, 9, 29, 28, 17])
ani = toy_plot.animate_trajs(animating_anchor_indices=[39, 40, 27])
...
movie_filename = "muller_potential_ratchet_4.mp4" 
